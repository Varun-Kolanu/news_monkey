...
export class News extends Component {
    ...
    async updateNews() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=ff1b6a42901a4c5db04989f7f408de53&page=${this.state.page}&pageSize=${this.props.pageSize}`
